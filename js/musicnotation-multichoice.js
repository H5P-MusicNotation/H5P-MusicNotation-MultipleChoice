...
const MNMC = (function () {
  ...
  function MusicNotationMultiChoice(options, contentId, contentData) {
    if (!(this instanceof MusicNotationMultiChoice))
      return new MusicNotationMultiChoice(options, contentId, contentData);
    var self = this;
  ...
  MusicNotationMultiChoice.prototype = Object.create(Question.prototype);
